            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="list-kartu_diskon.php">Kartu Diskon</a></li>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Persen Diskon</th>
                                    <td><?= $user['persen_diskon'] ?></td>
                                </tr>

                            </table>

                            <div class="m3">
                                <a href="list-kartu_diskon.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
                                <a href="edit-kartu_diskon.php ?id=<?= $user['id'] ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                <a href="delete-kartu_diskon.php ?id=<?= $user['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
