                                ...
                                <tbody>
                                    <?php foreach ($ProdukList as $index => $Produk): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="detail-produk.php?id=<?= $Produk['id'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i> Detail</a>
                                                <a href="edit-produk.php?id=<?= $Produk['id'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                                <a href="delete-produk.php?id=<?= $Produk['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus pemesanan ini?');"><i class="fas fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
