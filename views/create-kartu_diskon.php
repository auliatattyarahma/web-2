            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="list-kartu_diskon.php">Kartu Member</a></li>
                        <li class="breadcrumb-item active">Tambah</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-user-plus me-1"></i>
                            Form Tambah Data Kartu Member
                        </div>
                        <div class="card-body">
                            <form action="create-kartu_diskon.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="PersenDiskon" name="PersenDiskon" required>
                                </div>
